...
const App = () => {
  ...
  return (
    <div
      style={height}
      className="w-full h-full  bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500  bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center lg:pb-8 "
    >
      {/* {errorMsg && (
      ...
      <form
        ...
        } h-16 bg-black/30 w-full lg:max-w-[450px] max-w-[350px] rounded-full backdrop-blur-[32px] m-20 mb-6`}
      >
      ...
      {/* cards */}
      <div className="  w-full lg:max-w-[450px] max-w-[350px] bg-black/30 min-h-[580px] text-white backdrop-blur-[32px] rounded-[32px] py-12 px-6 ">
        {loading ? (
      ...
      <h1 className="text-xl font-medium dark:text-white p-10 pb-4 lg:pb-15 ">
